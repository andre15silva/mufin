...
if [[ "$5" == *"nocritic"* ]]; then
    python src/filter_single_hunk.py --keep_single_file_only --keep_single_hunk_only --storage $1 --$2 ${datasets[$2]} --model_input $2_breaker_generated_bugs_$4_$5.json --model_output $2_breaker_generated_bugs_$4_$5_hunk.json > $1/$2_breaker_generated_bugs_$4_$5_hunk.out 2>&1
fi
