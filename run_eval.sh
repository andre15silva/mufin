...
python src/eval_model.py --storage $1 --$2 ${datasets[$2]} --model_input $2_test_samples.json --from_pretrained $3 --beam_width $4 --results_file $3/eval_$2_bw_$4.json > $3/eval_$2_bw_$4.out 2>&1
